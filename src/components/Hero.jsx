...
import { discount, robot, itsolutions } from "../assets";
    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[50px] text-[52px] text-white ss:leading-[80px] leading-[75px]">
          Empowering Your Business <span className="text-gradient"> With </span>{" "} <br className="sm:block hidden" />{" "}
          <span className="text-gradient ss:text-[68px] text-[52px]">Cutting Edge</span>{" "}
          </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 mr-10 relative`}>
        ...
        <img src={itsolutions} alt="billing" className="w-[100%] h-[80%] relative z-[5] rounded-[20%]" />
